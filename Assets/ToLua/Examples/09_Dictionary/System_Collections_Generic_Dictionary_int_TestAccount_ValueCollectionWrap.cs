...
public class System_Collections_Generic_Dictionary_int_TestAccount_ValueCollectionWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("New", new LuaCSFunction(_CreateSystem_Collections_Generic_Dictionary_int_TestAccount_ValueCollection));
	...
	static int GetEnumerator(IntPtr L)
	{
		try
		{
			...
			System.Collections.Generic.Dictionary<int,TestAccount>.ValueCollection obj = ToLua.CheckObject<System.Collections.Generic.Dictionary<int,TestAccount>.ValueCollection>(L, 1);
	...
	{
		System.Collections.Generic.Dictionary<int,TestAccount>.ValueCollection obj = null;
		try
		{
			obj = (System.Collections.Generic.Dictionary<int,TestAccount>.ValueCollection)ToLua.ToObject(L, 1);
			int ret = obj.Count;
